...
@Component({
  ...
  imports: [Ie11MarkdownComponent, DemoComponent, NgxExtendedPdfViewerModule, SetMinifiedLibraryUsageDirective, AsyncPipe, NgScrollbarExt, NgScrollbarAsyncViewport],
})
