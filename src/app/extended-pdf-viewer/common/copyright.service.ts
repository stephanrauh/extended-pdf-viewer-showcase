...
export class CopyrightService {
  private readonly copyrightHints: Record<string, string> = {
    ...
    'Portugues-para-principiantes.pdf': 'The example PDF has been published under a Creative Commons (CC BY-NC-SA 3.0) license at https://wisc.pb.unizin.org/portuguese/',
    ...
    'jbig2-demo.pdf': 'the PDF file is generated by pdf-creator/make-jbig2-demo.mjs and embeds a 1-bit bitmap encoded with /Filter /JBIG2Decode.',
    ...
    '160F-2019.pdf':
      'the form ("Certificat de salaire, de retenue d\'impôt et de crédits d\'impôt bonifiés 2019", modèle 160) has been published by the Administration des contributions directes (ACD), Luxembourg. The same file is used as a test document by the pdf.js project.',
    ...
    'pdf-actions-demo.pdf': 'the PDF file is my own work; it is generated by build-tools/make-pdf-actions-demo.mjs.',
